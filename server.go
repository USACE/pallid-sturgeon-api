...
func main() {
	...
	e.POST(urlContext+"/siteDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateSiteDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/fishDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateFishDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/moriverDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateMoriverDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/supplementalDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateSupplementalDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/searchDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateSearchDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/telemetryDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateTelemetryDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/procedureDataEntryUpdate", auth.Authorize(PallidSturgeonH.UpdateProcedureDataEntry, PUBLIC))
	...
	e.POST(urlContext+"/userRoleOfficeUpdate", auth.Authorize(userH.UpdateUserRoleOffice, ADMIN))
