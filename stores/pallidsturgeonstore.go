...
var getSitesExportSql = `select site_id, site_fid, year, fieldoffice, field_office_description, project_id, project_description, segment_id, segment_description, season, season_description, bend, bendrn,
