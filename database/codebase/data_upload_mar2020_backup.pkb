...
--            END IF;  
     ...
     -- insert into ds_moriver
      INSERT into ds_moriver (site_id, mr_fid, season, setdate, subsample, subsamplepass, comments, last_updated,
        ...
        WHERE mr.uploaded_by = p_user
         and mr.upload_session_id = p_mrSessionID;
 ...
 WHERE upload_session_id = p_fishSessionID;
                                     p_debug ('Around line 2546. p_fishSessionID =' || p_fishSessionID, NULL);
 ...
 WHERE upload_session_id = p_suppSessionID;
                               ...
                               p_debug ('Around line 2663. p_suppSessionID = ' || p_suppSessionID, NULL);
 ...
 FOR Y in (
  ...
  END LOOP;
                                p_debug ('Around line 2692. p_suppSessionID = ' || p_suppSessionID, NULL);
